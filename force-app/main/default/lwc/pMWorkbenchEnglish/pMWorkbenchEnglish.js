...
import { OMNIDEF } from './pMWorkbenchEnglish_def.js';
import tmpl from './pMWorkbenchEnglish.html';
import tmpl_nds from './pMWorkbenchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pMWorkbenchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
