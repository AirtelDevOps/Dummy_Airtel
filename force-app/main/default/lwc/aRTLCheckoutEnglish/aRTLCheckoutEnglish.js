...
import { OMNIDEF } from './aRTLCheckoutEnglish_def.js';
import tmpl from './aRTLCheckoutEnglish.html';
import tmpl_nds from './aRTLCheckoutEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLCheckoutEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
