...
import { OMNIDEF } from './aRTLAddGSTEnglish_def.js';
import tmpl from './aRTLAddGSTEnglish.html';
import tmpl_nds from './aRTLAddGSTEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLAddGSTEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
