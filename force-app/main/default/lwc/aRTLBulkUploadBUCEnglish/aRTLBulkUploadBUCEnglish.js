...
import { OMNIDEF } from './aRTLBulkUploadBUCEnglish_def.js';
import tmpl from './aRTLBulkUploadBUCEnglish.html';
import tmpl_nds from './aRTLBulkUploadBUCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLBulkUploadBUCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
