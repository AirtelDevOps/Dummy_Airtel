...
import { OMNIDEF } from './pMWorkbenchSendKickOffEmailEnglish_def.js';
import tmpl from './pMWorkbenchSendKickOffEmailEnglish.html';
import tmpl_nds from './pMWorkbenchSendKickOffEmailEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pMWorkbenchSendKickOffEmailEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
