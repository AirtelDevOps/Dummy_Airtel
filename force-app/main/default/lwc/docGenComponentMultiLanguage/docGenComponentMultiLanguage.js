...
import { OMNIDEF } from './docGenComponentMultiLanguage_def.js';
import tmpl from './docGenComponentMultiLanguage.html';
import tmpl_nds from './docGenComponentMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenComponentMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
