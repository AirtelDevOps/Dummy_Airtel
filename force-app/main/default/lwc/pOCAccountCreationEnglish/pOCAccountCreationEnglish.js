...
import { OMNIDEF } from './pOCAccountCreationEnglish_def.js';
import tmpl from './pOCAccountCreationEnglish.html';
import tmpl_nds from './pOCAccountCreationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pOCAccountCreationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
