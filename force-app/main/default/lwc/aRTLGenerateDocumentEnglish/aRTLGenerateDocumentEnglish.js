...
import { OMNIDEF } from './aRTLGenerateDocumentEnglish_def.js';
import tmpl from './aRTLGenerateDocumentEnglish.html';
import tmpl_nds from './aRTLGenerateDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLGenerateDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
