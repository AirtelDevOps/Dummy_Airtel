...
import { OMNIDEF } from './aRTLCreateNBAEnglish_def.js';
import tmpl from './aRTLCreateNBAEnglish.html';
import tmpl_nds from './aRTLCreateNBAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLCreateNBAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
