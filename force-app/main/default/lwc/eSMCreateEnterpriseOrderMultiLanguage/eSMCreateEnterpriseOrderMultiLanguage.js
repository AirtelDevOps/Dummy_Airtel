...
import { OMNIDEF } from './eSMCreateEnterpriseOrderMultiLanguage_def.js';
import tmpl from './eSMCreateEnterpriseOrderMultiLanguage.html';
import tmpl_nds from './eSMCreateEnterpriseOrderMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eSMCreateEnterpriseOrderMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
