...
import { OMNIDEF } from './aRTLLaunchOVDetailsFlowEnglish_def.js';
import tmpl from './aRTLLaunchOVDetailsFlowEnglish.html';
import tmpl_nds from './aRTLLaunchOVDetailsFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLLaunchOVDetailsFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
