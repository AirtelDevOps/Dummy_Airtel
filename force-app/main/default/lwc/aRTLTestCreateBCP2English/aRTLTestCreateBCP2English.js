...
import { OMNIDEF } from './aRTLTestCreateBCP2English_def.js';
import tmpl from './aRTLTestCreateBCP2English.html';
import tmpl_nds from './aRTLTestCreateBCP2English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLTestCreateBCP2English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
