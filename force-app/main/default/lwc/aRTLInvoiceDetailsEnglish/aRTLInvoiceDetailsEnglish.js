...
import { OMNIDEF } from './aRTLInvoiceDetailsEnglish_def.js';
import tmpl from './aRTLInvoiceDetailsEnglish.html';
import tmpl_nds from './aRTLInvoiceDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aRTLInvoiceDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
