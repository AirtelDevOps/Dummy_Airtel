...
import { OMNIDEF } from './pMWorkbenchChangePMEnglish_def.js';
import tmpl from './pMWorkbenchChangePMEnglish.html';
import tmpl_nds from './pMWorkbenchChangePMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pMWorkbenchChangePMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
